...
public class Graphics {
	...
	display = Engine.redc + "Opponent Hero: " + Engine.opponentHero.name + "\n"
	    ...
	    + "Power: " + Engine.opponentHero.description.substring(0, Engine.opponentHero.description.length()-1) + " | " 
	    ...
	    + Engine.redc + "Power: " + Engine.playerHero.description.substring(0, Engine.playerHero.description.length()-1) + " | "
